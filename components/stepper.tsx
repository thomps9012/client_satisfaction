...
const Stepper = ({ active_link }: { active_link: string }) => {
  return (
    <ol className="flex justify-between mx-auto items-center w-full text-md font-medium text-center text-gray-500 mb-10 pb-10 text-xs sm:text-sm md:text-md lg:text-lg">
      <li
        className={
          active_link === "begin"
